...
public class CoursResource {
     ...
     */
    @GetMapping("/cours")
    public ResponseEntity<List<CoursDTO>> getAllCours(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
